...
KNOB<string> KnobStartRoutine(KNOB_MODE_WRITEONCE, "pintool",
    "s", "start_where_we_exist", "specify start c routine name");
KNOB<string> KnobEndRoutine(KNOB_MODE_WRITEONCE, "pintool",
    "e", "stop_where_we_exist", "specify end c routine name");
/* ===================================================================== */
/* Print Help Message                                                    */
/* ===================================================================== */
...
VOID Instruction(INS ins, VOID *v)
{
    ...
    string n = RTN_Name(rtn);

    if (n == KnobStartRoutine.Value()) {
        TraceFile << n << std::endl;
        startTrace = true;
    } else if (n == KnobEndRoutine.Value()) {
        TraceFile << n << std::endl;
        startTrace = false;
    }
